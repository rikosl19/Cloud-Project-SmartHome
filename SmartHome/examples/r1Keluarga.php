                    ...
                    <div class="row">
                      <script type="text/javascript">
                        function reloadStatus() {
                          ...
                          $("#Lampu").load('../service/control_box/status_lampu_R2.php');
                          $("#DLampu").load('../service/control_box/status_lampu_denah_R2.php');

                          $("#Kipas").load('../service/control_box/status_kipas_R2.php');
                          $("#DKipas").load('../service/control_box/status_kipas_denah_R2.php');
                      ...
                      <div class="col-md-3">
                        ...
                        <script type="text/javascript">
                          $("#LampuON").click(function() {
                            $.ajax({
                              url: "../service/control_box/proses_update2.php",
                              type: 'GET',
                              data: {
                                status_lmp2: 'ON1',
                                massage: 'Menyala1'
